...
public class TrackingPage4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracking_page4);
...
// last page so this may not be needed
        option1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TrackingPage4.this,TrackingPage.class);
        ...
        option2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TrackingPage4.this,TrackingPage2.class);
                startActivity(intent);
            }
        });
        ...
        option3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TrackingPage4.this,TrackingPage3.class);
                startActivity(intent);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TrackingPage4.this,HomePage.class);
                startActivity(intent);
            }
        });
