...
public class TrackingPage3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracking_page3);
...
//        titleYears.setBackgroundColor(Color.BLUE);
        ...
        option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(TrackingPage3.this,TrackingPage.class);
                startActivity(intent);
            }
        });
        ...
        option2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TrackingPage3.this,TrackingPage2.class);
                startActivity(intent);
            }
        });
        ...
        option3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TrackingPage3.this,TrackingPage4.class);
                startActivity(intent);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TrackingPage3.this,HomePage.class);
                startActivity(intent);
            }
        });
    }
